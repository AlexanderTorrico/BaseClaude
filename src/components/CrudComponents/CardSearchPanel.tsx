...
import { Row, Col, InputGroup, InputGroupText, Input, Button, Badge } from "reactstrap";
...
CardSearchPanel).isRequired,
  usuariosFiltradosCards: usuarios: onSearchChange: onSortFieldChange: onSortDirectionChange: onClearFilters: // Props para título y acciones
  onAddUser: onBulkDelete: selectedUsers: onViewModeChange: currentViewMode: };
