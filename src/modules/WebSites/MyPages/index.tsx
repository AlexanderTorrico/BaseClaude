        ...
        <Row className="mb-4">
          <Col xs={12}>
            <div className="d-flex justify-content-between align-items-center">
              <div>
                <h4 className="mb-1">Mis Páginas Web</h4>
              ...
              <div className="d-flex gap-2 align-items-center">
                ...
                <span className="badge bg-primary font-size-14">
                  {mypagess.length} {mypagess.length === 1 ? 'página' : 'páginas'}
                </span>
              </div>
            </div>
          </Col>
            ...
            {loading && mypagess.length === 0 ? (
              <Card className="border">
                <CardBody className="text-center py-5">
                  ...
                  <p className="text-muted mt-3 mb-0">Cargando páginas...</p>
                </CardBody>
              </Card>
            ) : mypagess.length === 0 ? (
              <Card className="border">
                <CardBody className="text-center py-5">
                  ...
                  <h5 className="text-muted">No tienes páginas creadas</h5>
                  <p className="text-muted mb-0">
                    Crea tu primera página web para comenzar
                  </p>
                </CardBody>
              </Card>
            ) : (
