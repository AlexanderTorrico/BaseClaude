...
MobileCardSearchPanel).isRequired,
  handleCardSearchChange: handleCardSortFieldChange: handleCardSortDirectionChange: clearCardFilters: getActiveCardFilters: // Props para acciones
