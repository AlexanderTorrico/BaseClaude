...
const CrudBasicResponsive = () => {
  ...
  // Render AzTable view for web with FilterSummary
  const renderWebView = () => (
    <FilterSummary data={mockProducts} columns={filterColumns}>
        ...
        <>
          ...
          <div className="mb-3 d-flex justify-content-between align-items-center">
            <h6 className="text-muted mb-0">
              Mostrando {filteredData.length} de {mockProducts.length} productos
              {hasActiveItems && <span className="text-primary"> (filtrados)</span>}
            </h6>

          </div>

          {/* AzTable with filtered data */}
          <AzTable
            data={filteredData}
            columns={columns}
  ...
  // Render cards view for mobile with FilterSummary
        ...
        <>
          ...
          <div className="mb-3 d-flex justify-content-between align-items-center">
            <small className="text-muted">
              {filteredData.length} de {mockProducts.length} productos
              {hasActiveItems && <span className="text-primary"> (filtrados)</span>}
            </small>
      ...
      <Container fluid>
        <AzHeaderCardViewResponsive
          ...
          views={[
            ...
            { name: "Cards", icon: "mdi-card-multiple" },
          ...
          viewWeb={renderWebView()}
          viewTable={renderWebView()}
          viewMovil={renderMobileView()}
        />
      </Container>
    </div>
  );
