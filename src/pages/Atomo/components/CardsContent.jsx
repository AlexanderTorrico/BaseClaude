...
import AtomoCardsViewSimple from '../../../components/CrudComponents/AtomoCardsViewSimple';

/**
 * Componente de contenido para vista de cards de átomos
...
const CardsContent = ({ 
  ...
  return (
    <AtomoCardsViewSimple
      atomosFiltradosCards={unifiedFilteredData || filteredCardsData}
      atomos={data}
