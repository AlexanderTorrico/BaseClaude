...
UserCardsView).isRequired,
  onSearchChange: onSortFieldChange: onSortDirectionChange: onClearFilters: onEditUser: onDeleteUser: onAddUser: onBulkDelete: selectedUsers: onViewModeChange: currentViewMode: };
